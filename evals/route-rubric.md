...
| Dispatch | Agent-dispatch is used when choosing current session, same-runtime agents, or heterogeneous CLI agents. |
...
- Answers directly or runs a direct local action without explicitly selecting it.
